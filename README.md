...
The objective of the CircuitGuard project is to develop a fully automated system for defect detection and classification on Printed Circuit Boards (PCBs) using computer vision and deep learning techniques. This system leverages reference-based image subtraction to localize defects and a deep Convolutional Neural Network (CNN) (EfficientNet-B4) for robust classification of the defect type.
